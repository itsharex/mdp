...
public class ArgumentAssert {
     ...
     * @throws ArgumentException if the collection is {@code null} or has no elements
     */
    public static <E, T extends Iterable<E>> T empty(T collection, String errorMsgTemplate, Object... params) throws ArgumentException {
        return empty(collection, () -> new ArgumentException(StrUtil.format(errorMsgTemplate, params)));
    }
