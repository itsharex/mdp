...
package top.mddata.base.captcha.slider.properties;
...
import static top.mddata.base.captcha.slider.properties.SliderCaptchaProperties.PREFIX;
...
public class SliderCaptchaProperties {
    public static final String PREFIX = Constants.PROJECT_PREFIX + ".captcha.slider";
    /**
     * 是否启用
     */
