...
public class SaSsoServerUtil {
    ...
    public static void deleteTicket(String ticket) {
        SaSsoServerProcessor.getInstance().getSsoServerTemplate().deleteTicket(ticket);
    }
    ...
    public static String createTicketAndSave(String client, Object loginId, String tokenValue) {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().createTicketAndSave(client, loginId, tokenValue);
    }
    ...
    public static TicketModel getTicket(String ticket) {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().getTicket(ticket);
    }
    ...
    public static Object getLoginId(String ticket) {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().getLoginId(ticket);
    }
    ...
    public static <T> T getLoginId(String ticket, Class<T> cs) {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().getLoginId(ticket, cs);
    }
    ...
    public static TicketModel checkTicket(String ticket) {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().checkTicket(ticket);
    }
    ...
    public static TicketModel checkTicketParamAndDelete(String ticket) {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().checkTicketParamAndDelete(ticket);
    }
    ...
    public static TicketModel checkTicketParamAndDelete(String ticket, String client) {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().checkTicketParamAndDelete(ticket, client);
    }
    ...
    public static String getTicketValue(String client, Object loginId) {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().getTicketValue(client, loginId);
    }
    ...
    public static List<SaSsoClientModel> getClients() {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().getClients();
    }
    ...
    public static SaSsoClientModel getClient(String client) {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().getClient(client);
    }
    ...
    public static SaSsoClientModel getClientNotNull(String client) {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().getClientNotNull(client);
    }
    ...
    public static SaSsoClientModel getAnonClient() {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().getAnonClient();
    }
    ...
    public static List<SaSsoClientModel> getNeedPushClients() {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().getNeedPushClients();
    }
    ...
    public static String buildRedirectUrl(String client, String redirect, Object loginId, String tokenValue) {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().buildRedirectUrl(client, redirect, loginId, tokenValue);
    }
    ...
    public static void checkRedirectUrl(String client, String url) {
        SaSsoServerProcessor.getInstance().getSsoServerTemplate().checkRedirectUrl(client, url);
    }
    ...
    public static void ssoLogout(Object loginId) {
        SaSsoServerProcessor.getInstance().getSsoServerTemplate().ssoLogout(loginId);
    }
    ...
    public static void ssoLogout(Object loginId, SaLogoutParameter logoutParameter, String ignoreClient) {
        SaSsoServerProcessor.getInstance().getSsoServerTemplate().ssoLogout(loginId, logoutParameter, ignoreClient);
    }
    ...
    public static String pushMessage(SaSsoClientModel clientModel, SaSsoMessage message) {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().pushMessage(clientModel, message);
    }
    ...
    public static SaResult pushMessageAsSaResult(SaSsoClientModel clientModel, SaSsoMessage message) {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().pushMessageAsSaResult(clientModel, message);
    }
    ...
    public static String pushMessage(String client, SaSsoMessage message) {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().pushMessage(client, message);
    }
    ...
    public static SaResult pushMessageAsSaResult(String client, SaSsoMessage message) {
        return SaSsoServerProcessor.getInstance().getSsoServerTemplate().pushMessageAsSaResult(client, message);
    }
    ...
    public static void pushToAllClient(SaSsoMessage message) {
        SaSsoServerProcessor.getInstance().getSsoServerTemplate().pushToAllClient(message);
    }
    ...
    public static void pushToAllClient(SaSsoMessage message, String ignoreClient) {
        SaSsoServerProcessor.getInstance().getSsoServerTemplate().pushToAllClient(message, ignoreClient);
    }
