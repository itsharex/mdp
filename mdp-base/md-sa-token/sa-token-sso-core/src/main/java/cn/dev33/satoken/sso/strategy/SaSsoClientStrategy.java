...
public class SaSsoClientStrategy {
     ...
     * <p> 返回值：返回给前端的值
     */
    private TicketResultHandleFunction ticketResultHandle = null;
     ...
     * <p> 返回值：本地 loginId
     */
    private SaParamRetFunction<Object, Object> convertCenterIdToLoginId = (centerId) -> {
        return centerId;
    };
     ...
     * <p> 返回值：认证中心 centerId
     */
    private SaParamRetFunction<Object, Object> convertLoginIdToCenterId = (loginId) -> {
        return loginId;
    };
