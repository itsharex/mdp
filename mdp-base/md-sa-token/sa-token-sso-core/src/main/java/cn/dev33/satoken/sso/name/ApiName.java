...
public class ApiName {
    ...
    /** SSO-Server端：授权地址 */
    private String ssoAuth = "/sso/auth";
    ...
    /** SSO-Server端：接收推送消息 */
    private String ssoPushS = "/sso/pushS";

    /** SSO-Server端：获取userinfo  */
    private String ssoUserinfo = "/sso/userinfo";

    /** SSO-Server端：单点注销地址 */
    private String ssoSignout = "/sso/signout";

    /** SSO-Client端：登录地址 */
    private String ssoLogin = "/sso/login";

    /** SSO-Client端：单点注销地址 */
    private String ssoLogout = "/sso/logout";

    /** SSO-Client端：判断当前是否登录地址 */
    private String ssoIsLogin = "/sso/isLogin";

    /** SSO-Client端：单点注销的回调 */
    private String ssoLogoutCall = "/sso/logoutCall";

    /** SSO-Client端：接收推送消息 */
    private String ssoPushC = "/sso/pushC";
