...
public class TreeFormTsxGenerator implements IGenerator {

    private GenTypeEnum genType;

    public TreeFormTsxGenerator() {
        this(GenTypeEnum.TREE_FORM_TSX);
    }

    public TreeFormTsxGenerator(GenTypeEnum genType) {
