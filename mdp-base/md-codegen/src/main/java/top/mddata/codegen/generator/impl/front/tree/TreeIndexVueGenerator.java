...
public class TreeIndexVueGenerator implements IGenerator {

    private GenTypeEnum genType;

    public TreeIndexVueGenerator() {
        this(GenTypeEnum.TREE_INDEX_VUE);
    }

    public TreeIndexVueGenerator(GenTypeEnum genType) {
