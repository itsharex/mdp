...
public class DetailTsxGenerator implements IGenerator {

    private GenTypeEnum genType;

    public DetailTsxGenerator() {
        this(GenTypeEnum.DETAIL_TSX);
    }

    public DetailTsxGenerator(GenTypeEnum genType) {
