...
public class TreeIndexTsxGenerator implements IGenerator {

    private GenTypeEnum genType;

    public TreeIndexTsxGenerator() {
        this(GenTypeEnum.TREE_INDEX_TSX);
    }

    public TreeIndexTsxGenerator(GenTypeEnum genType) {
