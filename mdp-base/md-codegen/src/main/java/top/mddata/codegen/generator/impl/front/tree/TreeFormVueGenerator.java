...
public class TreeFormVueGenerator implements IGenerator {

    private GenTypeEnum genType;

    public TreeFormVueGenerator() {
        this(GenTypeEnum.TREE_FORM_VUE);
    }

    public TreeFormVueGenerator(GenTypeEnum genType) {
