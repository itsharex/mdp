...
public class MoveVueGenerator implements IGenerator {

    private GenTypeEnum genType;

    public MoveVueGenerator() {
        this(GenTypeEnum.TREE_MOVE_VUE);
    }

    public MoveVueGenerator(GenTypeEnum genType) {
