...
#end
public class #(entityClassName)#(table.buildTreeExtends(isBase, table))#if(withActiveRecord) extends Model<#(entityClassName)>#else#(table.buildExtends(isBase))#(table.buildImplements())#end  {
    /** 表名称 */
