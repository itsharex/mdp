...
import top.mddata.console.permission.dto.ResourceButtonDto;
import top.mddata.console.permission.entity.ResourceButton;
import top.mddata.console.permission.query.ResourceButtonQuery;
import top.mddata.console.permission.service.ResourceButtonService;
import top.mddata.console.permission.vo.ResourceButtonVo;
...
public class ResourceButtonController extends SuperController<ResourceButtonService, ResourceButton> {
     ...
     */
    @PostMapping("/page")
    @Operation(summary = "分页列表查询", description = "分页查询按钮")
    @RequestLog(value = "'分页列表查询:第' + #params?.current + '页, 显示' + #params?.size + '行'", response = false)
    public R<Page<ResourceButtonVo>> page(@RequestBody @Validated PageParams<ResourceButtonQuery> params) {
        Page<ResourceButtonVo> page = Page.of(params.getCurrent(), params.getSize());
        ResourceButton entity = BeanUtil.toBean(params.getModel(), ResourceButton.class);
