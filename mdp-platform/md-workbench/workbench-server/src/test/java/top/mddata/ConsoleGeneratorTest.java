...
//        Class<?> entityClass = top.mddata.base.base.entity.BaseEntity.class;  // 3个字段
        ...
        // 设置根包和生成的表名
        //globalConfig.setBasePackage("com.fsfsfs.demo.test");
        globalConfig.setSourceDir(System.getProperty("user.dir") + "/mdp-platform/md-console");
        globalConfig.setBasePackage("top.mddata.console");
...
//        Class<?> entityClass = top.mddata.base.base.entity.BaseEntity.class;  // 3个字段
        ...
        // 设置根包和生成的表名
        //globalConfig.setBasePackage("com.fsfsfs.demo.test");
        globalConfig.setSourceDir(System.getProperty("user.dir") + "/mdp-platform/md-workbench");
...
//        Class<?> entityClass = top.mddata.base.base.entity.SuperEntity.class;   // 5个字段
        // 设置根包和生成的表名
        //globalConfig.setBasePackage("com.fsfsfs.demo.test");
        globalConfig.setSourceDir(System.getProperty("user.dir") + "/mdp-platform/md-open");
