...
package top.mddata.codegen.generator.impl.front.tree;
...
public class MoveTsxGenerator implements IGenerator {

    private GenTypeEnum genType;

    public MoveTsxGenerator() {
        this(GenTypeEnum.TREE_MOVE_TSX);
    }

    public MoveTsxGenerator(GenTypeEnum genType) {
