...
public class TreeVueGenerator implements IGenerator {

    private GenTypeEnum genType;

    public TreeVueGenerator() {
        this(GenTypeEnum.TREE_TREE_VUE);
    }

    public TreeVueGenerator(GenTypeEnum genType) {
