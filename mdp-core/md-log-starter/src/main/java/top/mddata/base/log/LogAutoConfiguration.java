...
public class LogAutoConfiguration {
    ...
    public SysLogAspect sysLogAspect(OptLogProperties properties) {
        return new SysLogAspect(properties);
    }
    ...
    public SysLogListener sysLogListener() {
        return new SysLogListener(log -> PointUtil.debug("0", "OPT_LOG", JSON.toJSONString(log)));
    }
}
