...
public class SaSsoClientUtil {
    ...
    public static SaSsoMessage buildCheckTicketMessage(String ticket, String ssoLogoutCallUrl) {
        return SaSsoClientProcessor.getInstance().getSsoClientTemplate().buildCheckTicketMessage(ticket, ssoLogoutCallUrl);
    }
    ...
    public static SaSsoMessage buildSignoutMessage(Object loginId, SaLogoutParameter logoutParameter) {
        return SaSsoClientProcessor.getInstance().getSsoClientTemplate().buildSignoutMessage(loginId, logoutParameter);
    }
